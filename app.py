...
def chat():
    ...
    if step == 'welcome':
        ...
        session['step'] = 'age'
        return jsonify(reply="👉 what is your age?")
    elif step == 'age':
        session['age'] = user_msg
        session['step'] = 'gender'
        return jsonify(reply="👉 what is your gender?")
    elif step == 'gender':
        ...
        if user_msg == 'yes':
            ...
            session['step'] = 'ended'
            return jsonify(reply="Thank you very much for staying with us. Have a healthy day! 👋")
        else:
